...
def run_fk_only(graph, task_table, num_classes):
    ...
    train_and_evaluate(model, graph, task_table, optimizer, loss_fn, tag="FK-only", log_filename="results/synthetic-fk-pk.txt")
...
if __name__ == "__main__":
    ...
    #run_fk_only(graph, task_table, num_classes)
